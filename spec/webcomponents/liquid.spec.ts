...
import { NostoAutocomplete as NostoAutocompleteLiquid } from "../../src/liquid/NostoAutocomplete"
import { defaultLiquidTemplate as liquidTemplate } from "../../src/liquid/fromLiquidTemplate"
...
describe("Liquid supported web component wrapper", () => {
  ...
  beforeEach(() => {
    document.body.innerHTML = `
        <nosto-autocomplete>
          ...
          <template type="text/x-liquid">${liquidTemplate}</template>
        </nosto-autocomplete>
      `

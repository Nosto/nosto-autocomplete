...
import { NostoAutocomplete as NostoAutoCompleteMustache } from "../../src/mustache/NostoAutocomplete"
import { defaultMustacheTemplate as mustacheTemplate } from "../../src/mustache/fromMustacheTemplate"
...
describe("Mustache supported web component wrapper", () => {
  ...
  beforeEach(() => {
    document.body.innerHTML = `
        <nosto-autocomplete>
          ...
          <template type="text/x-mustache-template">${mustacheTemplate}</template>
        </nosto-autocomplete>
      `

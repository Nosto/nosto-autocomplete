...
export interface InputSearchKeywords {
    ...
    /** `(Private key only)` Matches all objects if query is not provided or empty. Defaults to false. */
...
export interface InputSearchProducts {
    ...
    /** `(Private key only)` Matches all objects if query is not provided or empty. Defaults to true if no name provided, false for serp and autocomplete */
    emptyQueryMatchesAll?: InputMaybe<Scalars['Boolean']['input']>
